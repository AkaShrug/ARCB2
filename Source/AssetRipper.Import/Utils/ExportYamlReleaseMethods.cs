...
namespace AssetRipper.SourceGenerated.Helpers
{
	...
	internal static class ExportYamlReleaseMethods
	{
		...
		public static YamlNode ExportYamlRelease_Array_PPtr_AnimationClip_5_0_0_GICB2(this AssetList<PPtr_AnimationClip_5_0_0_GICB2> value, IExportContainer container)
		{
			YamlSequenceNode yamlSequenceNode = new YamlSequenceNode(SequenceStyle.Block);
			int count = value.Count;
			for (int i = 0; i < count; i++)
		...
		public static YamlNode ExportYamlRelease_Array_SplatPrototype_5_0_1_GICB2(this AssetList<SplatPrototype_5_0_1_GICB2> value, IExportContainer container)
		{
			YamlSequenceNode yamlSequenceNode = new YamlSequenceNode(SequenceStyle.Block);
			int count = value.Count;
			for (int i = 0; i < count; i++)
